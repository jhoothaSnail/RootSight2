           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-start justify-between">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <div className="text-sm md:text-base lg:text-lg font-semibold text-zinc-200">Google OAuth API</div>
                      <span className="px-1.5 py-0.5 rounded bg-red-500/20 border border-red-500/30 text-[10px] md:text-xs lg:text-sm font-mono uppercase tracking-widest text-red-500 font-bold animate-pulse">Critical</span>
                    </div>
                    <div className="text-xs md:text-sm lg:text-base font-mono text-red-400 uppercase tracking-widest">Degraded • 504 Timeout</div>
                  </div>
                  <Globe className="w-6 h-6 md:w-8 md:h-8 text-red-500/50" />
                </div>
                <div className="flex items-center gap-6 text-xs md:text-sm lg:text-base font-mono border-t border-red-500/10 pt-3">
                   <div className="flex flex-col gap-0.5">
                     <span className="text-zinc-500 uppercase tracking-wider">Affected Services</span>
                     <span className="text-zinc-200 font-bold text-xs md:text-sm lg:text-base">4</span>
                   </div>
                   <div className="flex flex-col gap-0.5">
                     <span className="text-zinc-500 uppercase tracking-wider">Affected Users</span>
                     <span className="text-zinc-200 font-bold text-xs md:text-sm lg:text-base">12.4k</span>
                   </div>
                </div>
              </div>
              <div className="p-4 rounded border bg-[#0d0d0f] border-zinc-900 flex flex-col justify-between gap-4">
                <div className="flex items-start justify-between">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <div className="text-sm md:text-base lg:text-lg font-semibold text-zinc-200">Twilio Webhooks</div>
                      <span className="px-1.5 py-0.5 rounded bg-teal-500/10 border border-teal-500/20 text-[10px] md:text-xs lg:text-sm font-mono uppercase tracking-widest text-teal-500 font-bold">Healthy</span>
                    </div>
                    <div className="text-xs md:text-sm lg:text-base font-mono text-teal-500 uppercase tracking-widest">Stable Response</div>
                  </div>
                  <Globe className="w-6 h-6 md:w-8 md:h-8 text-zinc-700" />
                </div>
                <div className="flex items-center gap-6 text-xs md:text-sm lg:text-base font-mono border-t border-zinc-800/50 pt-3">
                   <div className="flex flex-col gap-0.5">
                     <span className="text-zinc-500 uppercase tracking-wider">Affected Services</span>
                     <span className="text-zinc-400 font-bold text-xs md:text-sm lg:text-base">0</span>
                   </div>
                   <div className="flex flex-col gap-0.5">
                     <span className="text-zinc-500 uppercase tracking-wider">Affected Users</span>
                     <span className="text-zinc-400 font-bold text-xs md:text-sm lg:text-base">0</span>
              ...
              <div className="p-4 rounded border bg-[#0d0d0f] border-zinc-900 flex flex-col justify-between gap-4">
                <div className="flex items-start justify-between">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <div className="text-sm md:text-base lg:text-lg font-semibold text-zinc-200">Razorpay Payment</div>
                      <span className="px-1.5 py-0.5 rounded bg-teal-500/10 border border-teal-500/20 text-[10px] md:text-xs lg:text-sm font-mono uppercase tracking-widest text-teal-500 font-bold">Healthy</span>
                    </div>
                    <div className="text-xs md:text-sm lg:text-base font-mono text-teal-500 uppercase tracking-widest">Stable Response</div>
                  </div>
