...
//
// Single source of truth for the demo incident simulator. Each scenario carries:
//   • events   — the raw symptom stream surfaced in the live feed
//   • analysis — the curated root-cause result used when the AI/graph path is
//                unavailable, and as the grounding context for Gemini explanations
//
// Entity names here are kept consistent with the dependency graph (see
// backend/graph.json and shared/mocks/graph-success.json) so root cause, blast
// radius, ownership and runbooks all line up across the product.
